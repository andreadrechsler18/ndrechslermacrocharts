"""
Fetch Census Bureau Monthly Wholesale Trade (MWTS) data.
"""
...
CENSUS_BASE = "https://api.census.gov/data/timeseries/eits/mwts"
...
def run():
    print("Fetching Wholesale Trade data from Census Bureau...")
    keys = load_api_keys()
    api_key = keys["census"]
    ...
    result = {
        "metadata": {
            ...
            "source": "Census Bureau Monthly Wholesale Trade Survey (MWTS)",
    ...
    write_json(result, "wholesale/wholesale.json")
